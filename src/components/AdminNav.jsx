  ...
  return (
    <>
      ...
      <div className="px-4 py-5 border-b border-gray-100 dark:border-gray-700">
        ...
        <p className="text-sm font-bold text-gray-800 dark:text-gray-100 mt-0.5">Fleet Portal</p>
      </div>
      ...
      <div className="px-2 py-3 border-t border-gray-100 dark:border-gray-700">
        <a
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-100 transition-colors"
        >
...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <aside className="hidden md:flex w-56 shrink-0 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex-col">
        <SidebarContent />
      </aside>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 flex md:hidden">
          ...
          <aside className="relative z-50 w-64 bg-white dark:bg-gray-800 flex flex-col shadow-xl">
            ...
            <button
              onClick={() => setMobileOpen(false)}
              className="absolute top-3 right-3 p-1.5 rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-200"
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="md:hidden flex items-center gap-3 px-4 py-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
          <button
            onClick={() => setMobileOpen(true)}
            className="p-1.5 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200"
          ...
          <span className="text-sm font-bold text-gray-800 dark:text-gray-100">Fleet Portal</span>
        </header>
